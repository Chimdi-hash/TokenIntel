  ...
  return (
    <main className="relative min-h-screen p-4 md:p-8 flex flex-col items-center overflow-x-hidden">
      ...
      <motion.div 
        ...
        animate="visible"
      >
        <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-panel border-indigo-500/30 text-indigo-300 text-sm font-semibold tracking-wide uppercase mb-4">
